...
class Youtube_v4:
    def __init__(self):
        ...
        self.lista_cache_links_add.config(height=5, width=140)
        self.lista_cache_links_add.pack(anchor='center', fill=tk.BOTH, pady=5, padx=5)
        # --------------------------------------------------------------------------------------------------------------
        """#### Barra de rolagem da lista de cache"""
        self.barra_rolagem_lista_cache_Y = Scrollbar(self.frame_label_lista_cache, orient=tk.VERTICAL)
        self.barra_rolagem_lista_cache_Y.place(in_=self.barra_rolagem_lista_cache_Y)
