...
class Youtube_v4:
    def __init__(self):
        ...
        self.var_radio_ = tk.BooleanVar()
        self.radio_mp3_midia = Radiobutton(self.frame_lbl_botao_radio_opc_midia, text='Downloads (MP3)')
        self.radio_mp3_midia.config(variable=self.var_radio_.get, value=True)
        ...
        self.radio_mp4_midia.config(variable=self.var_radio_.get, value=True)
